...
import "./HoverCartslider.css"
function HoverCartslider() {
    
    
    const [closer, setCloser] = useState(false);
    const close2 = ()=>{
        const a = document.querySelector("#drawer");
        console.log(closer)
        if (!closer){
  ...
  return (
    <div id='drawer' className="absolute hidden md:flex -right-[100%] top-0  bg-orange-100 px-2 h-[100%]">
        <div className="flex  flex-col mx-auto w-[25rem] pl-5">
            <div className='justify-end text-right  text-white w-auto '>
                <div className='px-2 mx-auto bg-orange-500 w-7 float-right' onClick={close2}>

                <i class="fa-solid fa-xmark"></i></div>
                </div>
            <div>
                <h2 className='text-lg font-bold font-serif uppercase  text-center'>Cart item</h2>
            ...
            <div className='flex-col space-y-2' >
                ...
                <div className='font-bold text-base uppercase  px-2'>
                        price:  {"200"}
                    </div>
            </div>
            <hr />
            ...
            <div className='flex flex-col justify-center space-y-2 '>
                ...
                <div className='flex justify-between'>
                    <p className='text-lg font-bold uppercase'>total amount:</p>
                    <p className='font-bold px-2' >{"200"}</p>
                </div>
...
export default HoverCartslider
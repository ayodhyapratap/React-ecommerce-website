...
<div class="carousel-inner relative w-full overflow-hidden">
  ...
  <div class="carousel-item active relative float-left  w-full">
    {/* <img
      ...
      alt="Wild Landscape"
    /> */}
      <div className="contianer flex justify-center items-center p-1 md:mx-auto space-x-1  md:space-x-[6rem] my-2">
          <div className="contianer hover:scale-x-105 transition-transform">
              <img src="https://www.ulcdn.net/media/collection/listings/Desktop_CarouselCurtains_home.jpg?1652079614" alt="" />
          </div>
          <div className="contianer hover:scale-x-105 transition-transform">
              <img src="https://www.ulcdn.net/media/collection/listings/Desktop_CarouselCushion_Covers_home.jpg?1652079634" alt="" />
          </div>
          <div className="contianer hover:scale-x-105 transition-transform">
              <img src="https://www.ulcdn.net/media/collection/listings/Desktop_CarouselBathroom_Accessories_home.jpg?1652079561" alt="" />
          </div>

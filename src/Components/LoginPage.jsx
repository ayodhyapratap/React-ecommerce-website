...
import facebook from "./ThirdPage/svgIcon/facebook.svg";
...
function LoginPage() {
  ...
  return (
    <div id="close"  className=" container-full hidden w-full h-[100vh]  fixed z-50 top-0 backdrop-brightness-50 left-0 right-0 bottom-0">
    ...
    <div className="container-full mx-auto w-[70vw] h-[30rem] flex absolute top-14 bg-slate-200 left-0 right-0 bottom-0 z-50 p-1 ">
      ...
      <div className="flex items-center w-[31rem] bg-white space-y-3 flex-col ">
        ...
        <div className="bg-orange-500 p-2 rounded w-[18.5rem] justify-center text-center transition-transform hover:scale-105 ">
          <button className="capitalize  font-bold ">Log in</button>
        </div>
        <div className="text-sm">
          Don't have an account?{" "}
          <span className="text-orange-500 hover:cursor-pointer">Sign-up</span>{" "}
        </div>
